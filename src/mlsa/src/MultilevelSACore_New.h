...
namespace mlsa {
    ...
    */
    class SimulatedAnnealingCore_New {
        public:
            SimulatedAnnealingCore_New(
        ...
        private:
            ...
            // Storing structure
            std::vector<Edge> nets_;               // Vector from the outer physical hierarchy tree
    ...
    }; // End of class SimulatedAnnealingCore_New
